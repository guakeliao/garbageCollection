...
function info() {
    return new Promise((resolve) => {
        ...
        const nm = {
            ...
            headers: {
                "Cookie": cookie, "Origin": "https://pushgold.jd.com", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36",
            }
        }
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.success == true) {
                            ...
                            if (data.data && data.data.packetId) {
                                inviteCodes.push({
                                    user: $.UserName, packetId: data.data.packetId, ok: false,
                                });
                            }
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.success == true && data?.data?.sponsorActivityInfo?.packetId) {
                            ...
                            if (data.data && data.data.sponsorActivityInfo.packetId) {
                                inviteCodes.push({
                                    user: $.UserName, packetId: data.data.sponsorActivityInfo.packetId, ok: false,
                                });
                            }
                        } else if (data.success == false) {
                            console.log(data.msg)
